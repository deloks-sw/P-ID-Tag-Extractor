...
export const DeleteButton = React.memo(({ onClick, title = "Delete" }: { onClick: () => void; title?: string }) => (
  <button
    onClick={(e) => {
      e.stopPropagation();
      onClick();
...
export const DeleteRelationshipButton = React.memo(({ onClick, title = "Delete relationship" }: { onClick: () => void; title?: string }) => (
  <button
    onClick={(e) => {
      e.stopPropagation();
      onClick();
...
export const CancelButton = React.memo(({ onClick, title = "Cancel" }: { onClick: () => void; title?: string }) => (
  <button
    ...
    className="p-1 rounded-full text-gray-500 hover:text-gray-600 transition-colors"
    title={title}
  >
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
